   ...
   public void searchingByID(){
         ...
         try {
              ...
              if(rs.next()){
                ...
                JOptionPane.showMessageDialog(null, "No record found with EmployeeID: " + employee, "Search Result", JOptionPane.INFORMATION_MESSAGE);
              }
         } catch (SQLException e) {
              JOptionPane.showMessageDialog(null, "Error: " + e.getMessage(), "Database Error", JOptionPane.ERROR_MESSAGE);
         }
   ...
   public void searchingByFullname(){
            ...
            try {
                ...
                if(rs.next()){
                    ...
                    JOptionPane.showMessageDialog(null, "No record found with EmployeeID: " + name, "Search Result", JOptionPane.INFORMATION_MESSAGE);
                }
            } catch (SQLException e) {
                JOptionPane.showMessageDialog(null, "Error: " + e.getMessage(), "Database Error", JOptionPane.ERROR_MESSAGE);
            }
   ...
   public void searchingByPhone(){
            ...
            try {
                ...
                if(rs.next()){
                    ...
                    JOptionPane.showMessageDialog(null, "No record found with EmployeeID: " + phone, "Search Result", JOptionPane.INFORMATION_MESSAGE);
                }
            } catch (SQLException e) {
                JOptionPane.showMessageDialog(null, "Error: " + e.getMessage(), "Database Error", JOptionPane.ERROR_MESSAGE);
            }
